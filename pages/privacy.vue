<template>
	<div class="mx-auto px-4">
		...
		<section class="py-12 px-4">
			...
			>
				<div class="mx-auto">
					<h2 class="text-center text-4xl mb-4 font-heading">Privacy Policy</h2>
					<p>
						Your privacy is important to us. It is CM Learning's policy to respect
						your privacy regarding any information we may collect from you across our
						website,
						<a href="https://esbp.xyz">https://esbp.xyz</a>, and other sites we own
						and operate.
					</p>
					<br />
					<p>
